# PyTorch3D-Rendering
Credit: This assignment is modified from CMU 3D Vision course.
...
To create a webpage, we recommend using MarkDeep. We have provided a template report_example/starter.md.html.
...
We recommand to use Conda to manage your environments. You can find how to install Conda here.
...
pip install -r requirements.txt
If you have access to a GPU, the rendering code may run faster, but everything should be able to run locally on a CPU.
...
More information about the renderer can be found here.
...
Again, the rotation and translations must be batched. You should familiarize yourself with the camera coordinate system that Pytorch3D uses. This wil save you a lot of headaches down the line.
...
You may find this website helpful to understand look-at transforms.
